    ...
    private function sendPaymentDeadlineReminders(): int
    {
        ...
        Booking::query()
            ...
            ->each(function (Booking $booking) use (&$reminded): void {
                ...
                $message = 'Payment for your booking is due '.$booking->payment_due_at->format('M d, Y g:i A').'. Pay before this time to keep your reservation.';
    ...
    private function markNoShows(): int
    {
        ...
        Booking::query()
            ...
            ->each(function (Booking $booking) use (&$count): void {
                ...
                $message = 'Your booking was cancelled as a no-show because check-in was not completed on time.';
        ...
        Booking::query()
            ...
            ->chunkById(100, function ($bookings) use (&$reminded): void {
                foreach ($bookings as $candidate) {
                    ...
                    $message = 'Check-in reminder: your stay starts on '.$booking->check_in->format('M d, Y').'.';
