    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <section class="soft-card p-4 p-lg-5">
                ...
                <p class="text-secondary mb-3">Review the pre-booking amount and choose how you want to pay.</p>

                <div class="alert alert-light border small mb-4" role="note">
                    <strong>Payment and booking confirmation are separate.</strong> Successful online payment is marked Paid automatically. Cash stays Unpaid until staff receives it. Only staff can confirm the booking.
                </div>
                ...
                <div class="checkout-summary mb-4">
                    ...
                    <div class="checkout-summary-item">
                        <span class="checkout-summary-label">Service charge (8%)</span>
                        <span class="checkout-summary-value">&#8369;{{ number_format($serviceFee, 2) }}</span>
                    </div>
                    <div class="checkout-summary-item">
                        <span class="checkout-summary-label">Breakfast</span>
                        <span class="checkout-summary-value">&#8369;{{ number_format($breakfastFee, 2) }}</span>
                    </div>
                    ...
                    <div class="checkout-summary-item text-secondary">
                        <span class="checkout-summary-label">Taxes excluded from this summary</span>
                        <span class="checkout-summary-value">VAT and local tax &mdash; itemized on receipt</span>
                    </div>
